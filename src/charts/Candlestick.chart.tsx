...
export class CandleChart extends Component {
	...
	componentDidMount() {
		...
		const candleSeries = chart.addCandlestickSeries({
			upColor: 'rgba(61, 204, 145, 1)',
			downColor: 'rgba(245, 86, 86, 1)',
			borderDownColor: 'rgba(245, 86, 86, 0.7)',
			borderUpColor: 'rgba(61, 204, 145, 0.7)',
			wickDownColor: 'rgba(245, 86, 86, 0.7)',
			wickUpColor: 'rgba(61, 204, 145, 0.7)',
		});
